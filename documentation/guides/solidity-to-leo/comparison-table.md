...
| **Dispatch Type**    | Static (`call`) and dynamic (`call.dynamic`) dispatch via [ARC-0009](https://github.com/ProvableHQ/ARCs/tree/master/arc-0009) | Dynamic dispatch |
...
| **Token Standard**   | [ARC-21](../standards/00_token_registry.md) (existing), [ARC-20](https://github.com/ProvableHQ/ARCs/discussions/124) / [ARC-22](https://github.com/ProvableHQ/ARCs/discussions/125) (draft) | ERC-20 |
